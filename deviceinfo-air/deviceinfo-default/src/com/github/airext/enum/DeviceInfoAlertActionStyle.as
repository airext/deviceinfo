...
public class DeviceInfoAlertActionStyle {
    ...
    public static const destructive: DeviceInfoAlertActionStyle   = new DeviceInfoAlertActionStyle(1);
    public static const cancellation: DeviceInfoAlertActionStyle  = new DeviceInfoAlertActionStyle(2);
