...
public class DeviceInfoAlertStyle {
    ...
    public static const alert: DeviceInfoAlertStyle       = new DeviceInfoAlertStyle(0);
    public static const actionSheet: DeviceInfoAlertStyle = new DeviceInfoAlertStyle(1);
